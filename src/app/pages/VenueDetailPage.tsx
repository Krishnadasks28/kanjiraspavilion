...
export function VenueDetailPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-ivory">
        <div className="text-center">
          <h1 className="text-4xl text-green-dark mb-4">Venue Not Found</h1>
          <Link to="/venues" className="text-gold hover:underline flex items-center justify-center gap-2">
  ...
  return (
    <main className="bg-ivory min-h-screen pb-20">
      <MetaTags />
      <PageHero
        title={venue.name}
        ...
        <div className="bg-white rounded-lg shadow-2xl overflow-hidden">
          <div className="grid lg:grid-cols-3 gap-0">
            ...
            <div className="lg:col-span-2 p-8 md:p-12">
              <Link
                to="/venues"
                className="inline-flex items-center text-green-medium hover:text-gold transition-colors mb-8 group"
              >
              ...
              <div className="flex items-center gap-4 mb-6">
                <div className="bg-gold/10 text-gold px-4 py-2 rounded-full flex items-center space-x-2">
                  <Users size={18} />
                  <span className="font-semibold">{venue.capacity} Guests Capacity</span>
                </div>
              </div>

              <h2 className="text-3xl md:text-4xl text-green-dark mb-6 font-serif">
                About the {venue.name}
              </h2>

              <p className="text-lg text-green-medium leading-relaxed mb-8">
            ...
            <div className="bg-primary p-8 md:p-12 text-white">
              <div className="sticky top-24">
                ...
                <div className="space-y-8">
                  <div>
                    <h4 className="text-gold uppercase tracking-widest text-xs mb-4">Features & Services</h4>
                  ...
                  <div>
                    <h4 className="text-gold uppercase tracking-widest text-xs mb-4">Ideal For</h4>
                  ...
                  <div className="pt-8 border-t border-white/10">
                    ...
                    <Link
                      to="/contact"
                      className="w-full flex items-center justify-center gap-2 py-4 bg-gold text-green-dark rounded-lg font-bold hover:bg-gold-light transition-all transform hover:-translate-y-1"
                    >
                      <Calendar size={20} />
                      Book this Venue
                    </Link>
